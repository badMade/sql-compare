...
class SQLCompareGUI:
    def __init__(self, root):
        ...
        pad = {"padx": 8, "pady": 6}
        self._setup_file_selection_frame(pad)
        self._setup_mode_frame(pad)
        self._setup_flags_frame(pad)
        self._setup_buttons_frame(pad)
        self._setup_output_frame(pad)
    ...
    def _setup_file_selection_frame(self, pad):
    ...
    def _setup_mode_frame(self, pad):
    ...
    def _setup_flags_frame(self, pad):
    ...
    def _setup_buttons_frame(self, pad):
    ...
    def _setup_output_frame(self, pad):
