...
def generate_report(result: dict, mode: str, fmt: str, out_path: str, ignore_ws: bool):
    ...
    def mk(title, a, b, fromname, toname):
        # difflib.HtmlDiff does not escape fromdesc or todesc.
        table = hd.make_table(a.splitlines(), b.splitlines(), fromdesc=html.escape(fromname), todesc=html.escape(toname), context=True, numlines=3)
