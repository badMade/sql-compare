...
class TestRemoveTrailingSemicolon(unittest.TestCase):
    ...
    def test_spaces_before_semicolon(self):
        # strip() won't remove spaces before the semicolon, but the semicolon is removed
        self.assertEqual(remove_trailing_semicolon("SELECT * FROM t ;"), "SELECT * FROM t ")

    def test_multiple_semicolons(self):
        # the function only strips the last character if it's a semicolon
        self.assertEqual(remove_trailing_semicolon("SELECT * FROM t;;"), "SELECT * FROM t;")
