...
class TestWorkflowSecurity(unittest.TestCase):
    ...
    def test_codex_has_helper_functions(self):
        ...
        # Check for helper functions (using actual function names from review-utils)
    ...
    def test_codex_has_pagination_limit(self):
        ...
        # fetchPrFilesWithPagination encapsulates pagination limits in review-utils
        self.assertIn('fetchPrFilesWithPagination', script, "Missing fetchPrFilesWithPagination function that handles pagination")
    ...
    def test_codex_review_has_retry_logic(self):
        ...
        # fetchWithRetry uses 'retries' parameter, not 'maxRetries'
    ...
    def test_codex_review_truncates_errors(self):
        ...
        # Check for error truncation using safeErrorMessage and safeReadBody helpers
        self.assertIn('safeErrorMessage', script, "Should use safeErrorMessage to truncate error messages")
        self.assertIn('safeReadBody', script, "Should use safeReadBody to safely read and truncate response bodies")
    ...
    def test_error_handler_catches_all_exceptions(self):
        ...
        for workflow_name, workflow, step_name in [
            ...
            # Check for safeErrorMessage usage in catch (actual function name)
    ...
    def test_pr_number_validation_consistency(self):
        ...
        for workflow_name, workflow in [('codex', self.codex_workflow), ('jules', self.jules_workflow)]:
            ...
            # Check for parsePrNumber helper (actual function name that encapsulates validation)
